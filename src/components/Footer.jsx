      ...
      <footer>
         <div className="footer-container flex flex-wrap mx-auto lg:max-w-screen-xl lg:px-8 md:px-24 px-24">
            <div className="basis-full sm:basis-1/2 lg:basis-1/4 mb-8 text-center lg:text-left">
               <div className="site-name">JobPortal</div>
               <div className="site-des my-5">
         ...
         <div className="rights flex flex-wrap lg:max-w-screen-xl mx-auto lg:px-8 md:px-24 px-8">
            <div className="right basis-full text-center sm:text-left sm:basis-1/2">
               @2023 <b>JobPortal</b>. All Rights Reserved
            </div>
            <div className="powered-by basis-full text-center sm:text-right sm:basis-1/2">
               Powered by <b>JobPortal</b>
            </div>
         </div>
      </footer>
   );
