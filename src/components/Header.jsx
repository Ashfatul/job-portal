   ...
   return (
      <div className="px-4 py-4 mx-auto sm:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
         <div className="relative flex items-center justify-between">
            <h1 className="header-site-name sm:text-left">
               <NavLink to="/">JobPortal</NavLink>
            </h1>
            ...
            <div className="flex lg:hidden">
               <button
                  ...
                  className="text-gray-500 hover:text-gray-600 focus:outline-none focus:text-gray-600 menu-toggler"
            ...
            <button className="start-applying-btn hidden lg:inline">
               Start Applying
            </button>
         </div>
         ...
         <div className={`lg:hidden ${!isMenuOpen && "hidden"}`}>
            <div className="px-2 pt-2 pb-3 small-menu">
               <NavLink
                  to="/"
                  className={({ isActive }) =>
                     isActive ? "block text-blue-600" : "block text-gray-500"
                  }
               >
                  Home
               </NavLink>
               ...
               <button className="start-applying-btn mt-5">
                  Start Applying
               </button>
            </div>
         </div>
